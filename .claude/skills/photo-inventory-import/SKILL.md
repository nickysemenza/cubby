...
description: Import household belongings or wardrobe photos into Cubby from a photo_inventory Run, preserving evidence, ownership, locations, and duplicate decisions.
---
