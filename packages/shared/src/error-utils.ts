...
export const AppErrors = {
  ...
  PERSON_HAS_LEDGER_EDGES: "PRECONDITION_FAILED",
  PERSON_USER_LINK_CONFLICT: "CONFLICT",
  HOUSEHOLD_LEDGER_PREVIEW_STALE: "CONFLICT",
  HOUSEHOLD_LEDGER_IDEMPOTENCY_CONFLICT: "CONFLICT",
  HOUSEHOLD_LEDGER_EVIDENCE_CONFLICT: "CONFLICT",
  HOUSEHOLD_LEDGER_INVALID_ATTRIBUTION: "BAD_REQUEST",
  HOUSEHOLD_LEDGER_INVALID_TRANSFER: "BAD_REQUEST",
  EXPENSE_SPLIT_ATTRIBUTION_REQUIRED: "BAD_REQUEST",
  EXPENSE_SPLIT_SOURCE_IDENTITY_CONFLICT: "PRECONDITION_FAILED",
