...
export const purchaseImportRunId = ENTITY_ID_SCHEMA.purchaseImportRun;
...
export type PurchaseImportRunId = EntityId<"purchaseImportRun">;
...
const PARSE_ENTITY_REF = {
  ...
  purchaseImportRun: entityRefParser("purchaseImportRun"),
