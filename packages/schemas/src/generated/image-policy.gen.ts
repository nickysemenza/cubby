...
// Artifact hashes: source=7588cb0db85898ac content=b68a61e80b5fe381
...
export const imagePolicyCatalog = {
  ...
  importRun: { storage: false, displaySources: [], ingress: [], routing: null },
  device: { storage: false, displaySources: [], ingress: [], routing: null },
