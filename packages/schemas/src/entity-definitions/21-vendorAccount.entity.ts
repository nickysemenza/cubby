...
export default defineEntity({
  ...
  model: {
    ...
    create: ["label", "vendorId", "ledgerPartyId", "status", "browser"],
    update: ["label", "vendorId", "ledgerPartyId", "status", "browser"],
    bulk: [],
    audit: ["label", "vendorId", "ledgerPartyId", "status", "browser"],
    sort: {
    ...
    intents: {
      fields: {
        ...
        full: ["label", "vendorId", "ledgerPartyId", "status", "browser"],
