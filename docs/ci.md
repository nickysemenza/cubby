...
| Pinned Caddy HTTPS/HTTP/2 proxy      | After [Scalar UI browser coverage was removed](https://github.com/nickysemenza/cubby/pull/1302), a complete exact-head [proxy run](https://github.com/nickysemenza/cubby/actions/runs/35939680610) passed, including h2 assets and the WebSocket check. It reached `Web checks` in **5:55**, the same as the [non-proxy control](https://github.com/nickysemenza/cubby/actions/runs/35939143367). Desktop jobs took **4:40 + 5:34** with the proxy versus **4:12 + 5:37** without it: about **25 more runner seconds**. Shard 2 page loads took **94.4s/37** with the proxy versus **92.0s/37** without it. The [experiment](https://github.com/nickysemenza/cubby/pull/1301) was closed under the 10% timing rule. |
