...
/**
 * Build the universal MCP Apps (SEP-1865) document. `build.mjs` runs it once;
 * the resource registrar injects the specific manifest app id before serving
 * either stable `ui://` URI.
 *
