/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --include-runtime=false --strict-vars=false` (hash: d538728741943db89d09ee0ef89cb57b)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "DatabaseFreshnessDurableObject" | "CalendarFeedDurableObject";
	}
