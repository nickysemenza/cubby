...
// Artifact hashes: source=862d63697ee8170a content=862d63697ee8170a
...
export const ENTITY_NATIVE_COVERAGE = {
  ...
  "inventory": {"httpActions":["create","get","list"],"imageAttach":false,"imageOrder":false,"rpcIds":["inventory.findDuplicates","inventory.getByLocationIds","inventory.moveEntries","inventory.reconcileSession","inventory.resolveScanStrays","inventory.scanAtLocation"]},
  ...
  "task": {"httpActions":["get","list","update"],"imageAttach":true,"imageOrder":true,"rpcIds":["task.todayBriefing"]},
  ...
  "expense": {"httpActions":["get","list","update"],"imageAttach":false,"imageOrder":false,"rpcIds":[]},
