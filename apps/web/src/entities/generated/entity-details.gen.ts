...
// Artifact hashes: source=d1435c8ff43cd35a content=854ade905da31774
...
const ENTITY_DETAIL_OUTPUT_SCHEMAS = {
  ...
  "productCategory": withEntityDetailMedia(productCategoryOut),
  "device": withEntityDetailMedia(deviceOut),
  "imageSighting": withEntityDetailMedia(imageSightingOut),
  "plant": withEntityDetailMedia(plantOut),
} as const;
...
export const entityDetailInputSchema = z.discriminatedUnion("entity", [
  ...
  z.object({entity:z.literal("productCategory"),shortcode:shortcodeSchema("productCategory")}),
  z.object({entity:z.literal("device"),shortcode:shortcodeSchema("device")}),
  z.object({entity:z.literal("imageSighting"),shortcode:shortcodeSchema("imageSighting")}),
  z.object({entity:z.literal("plant"),shortcode:shortcodeSchema("plant")})
]);
