...
const ApiImportRunsPublicIdPhotoAgentRoute =
  ApiImportRunsPublicIdPhotoAgentRouteImport.update({
    id: '/photo-agent',
    path: '/photo-agent',
    getParentRoute: () => ApiImportRunsPublicIdRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api/import/runs/$publicId/photo-agent': {
      id: '/api/import/runs/$publicId/photo-agent'
      path: '/photo-agent'
      fullPath: '/api/import/runs/$publicId/photo-agent'
      preLoaderRoute: typeof ApiImportRunsPublicIdPhotoAgentRouteImport
      parentRoute: typeof ApiImportRunsPublicIdRoute
    }
    '/api/import/runs/$publicId/photo-groups': {
