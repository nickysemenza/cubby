...
function Timeline({
  ...
  return (
    <TimelineContext.Provider
      value={{ activeStep: currentStep, mode, setActiveStep }}
    >
      {useRender({
        defaultTagName: "div",
        render,
...
function TimelineItem({
  ...
  const { activeStep, mode } = useTimeline()
  ...
  const defaultProps = {
    ...
    "data-completed":
      mode === "progress" && step <= activeStep ? true : undefined,
