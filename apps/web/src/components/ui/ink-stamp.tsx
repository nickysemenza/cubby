...
export function InkStamp({
  ...
  children: ReactNode;
  /** ink = warm brown (default), red = alert, green = positive */
  tone?: "ink" | "red" | "green";
  className?: string;
}) {
  return (
    <span
      className={cn(
        "inline-block -rotate-2 rounded-sm border-[1.5px] px-2 py-0.5 font-mono font-semibold text-2xs uppercase tracking-wider",
