...
function FieldGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/field-group @container/field-group flex w-full flex-col gap-2 data-[slot=checkbox-group]:gap-3 [&>[data-slot=field-group]]:gap-2",
        className,
      )}
      {...props}
    />
...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "has-data-checked:bg-primary/5 group/field-label peer/field-label flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border [&>*]:data-[slot=field]:p-2",
