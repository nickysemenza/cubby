...
export function registerProjectTools(server: McpServer) {
  ...
  registerEntityCrudToolset(server, {
    ...
    descriptions: {
      list: "List purchases (project spend ledger) with cost, date, costType/trade, purchaser, and project name. Filter by costType/trade/purchaser/projectId/future/search/includeSubProjects. Pass includeSubProjects=true with projectId to match the whole live subtree under that project, not just its own purchases.",
