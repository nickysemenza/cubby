 ...
 * done. Every site is greppable for `placement`, and each query that
 * deliberately keeps fixtures carries an `// includes-installed: <reason>`
 * comment so the decision is visible rather than assumed.
 */
