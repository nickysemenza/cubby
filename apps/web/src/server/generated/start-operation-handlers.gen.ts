...
// Artifact hashes: source=2459f01f111f0211 content=852ea9e61026c382
...
export const START_OPERATION_HANDLER_LOADERS = {
  ...
  "financialAccount.options": async () =>
    (await import("~/server/finance-browser.server")).financialAccountHandlers
      .operations.options,
  "financialTransaction.previewStatementImport": async () =>
    (await import("~/server/finance-browser.server"))
      .financialTransactionHandlers.operations.previewStatementImport,
  ...
  "oauth.revokeConnectedApp": async () =>
    (await import("~/server/oauth-browser.server")).oauthHandlers.operations
      .revokeConnectedApp,
  "photoImport.approveGroups": async () =>
    (await import("~/server/photo-import.server")).photoImportHandlers
      .operations.approveGroups,
  "photoImport.candidates": async () =>
    (await import("~/server/photo-import.server")).photoImportHandlers
      .operations.candidates,
  "photoImport.chooseExisting": async () =>
    (await import("~/server/photo-import.server")).photoImportHandlers
      .operations.chooseExisting,
  ...
  "photoImport.discardGroup": async () =>
    (await import("~/server/photo-import.server")).photoImportHandlers
      .operations.discardGroup,
  ...
  "photoImport.review": async () =>
    (await import("~/server/photo-import.server")).photoImportHandlers
      .operations.review,
  "photoImport.stage": async () =>
    (await import("~/server/photo-import.server")).photoImportHandlers
      .operations.stage,
  "photoImport.startGrouping": async () =>
    (await import("~/server/photo-import.server")).photoImportHandlers
      .operations.startGrouping,
  "photoImport.updateDraft": async () =>
    (await import("~/server/photo-import.server")).photoImportHandlers
  ...
  "statementRow.list": async () =>
    (await import("~/server/statement-row-browser.server")).statementRowHandlers
      .operations.list,
  "statementRow.previewCsv": async () =>
    (await import("~/server/statement-row-browser.server")).statementRowHandlers
      .operations.previewCsv,
  "statementRow.record": async () =>
    (await import("~/server/statement-row-browser.server")).statementRowHandlers
      .operations.record,
