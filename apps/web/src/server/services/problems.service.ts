    ...
    traceAllBounded(
      {
        runFindings: () =>
          diagnosticItems(
            db,
            "import-findings",
            allProblemsSchema.shape.runFindings,
          ),
        ...
        unconnectedEntities: () =>
          diagnosticItems(
            ...
            allProblemsSchema.shape.unconnectedEntities,
          ),
