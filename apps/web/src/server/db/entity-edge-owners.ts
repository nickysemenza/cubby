...
export const ENTITY_EDGE_OWNERS = {
  ...
  ImportRunTarget: { owner: importRunTarget.runId },
  ...
  ImportFinding: { excluded: WORKFLOW },
  ImportHunt: { excluded: WORKFLOW },
  ImportPreparedOrder: { excluded: WORKFLOW },
  ImportRunApproval: { excluded: WORKFLOW },
  ImportRunControlEvent: { excluded: WORKFLOW },
  ImportRunEvidence: { excluded: WORKFLOW },
  ImportRunMutation: { excluded: WORKFLOW },
  ImportRunOperation: { excluded: WORKFLOW },
  ImportRunOrderCandidate: { excluded: WORKFLOW },
  ImportRunProgress: { excluded: WORKFLOW },
