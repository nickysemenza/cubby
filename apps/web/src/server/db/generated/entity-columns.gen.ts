...
// Artifact hashes: source=4f5410531a86e0d6 content=e1ba957458ba61ac
...
export const generatedLocationColumns = (
  ...
  productId: uuid("productId")
    ...
    .references(references["product"]),
  type: text("type"),
  gardenKind: text("gardenKind"),
  gardenConditions: text("gardenConditions"),
...
export const generatedPurchaseColumns = (
  references: Readonly<{ vendor: () => AnyPgColumn }>,
) => ({
  id: uuid("id")
    .primaryKey()
    .default(sql`gen_random_uuid()`)
...
export const generatedPlantingColumns = (
  ...
  locationId: uuid("locationId")
    .$type<LocationId>()
    .references(references["location"]),
  intendedLocationId: uuid("intendedLocationId")
    .$type<LocationId>()
    .references(references["location"]),
  parentPlantingId: uuid("parentPlantingId").references(references["planting"]),
