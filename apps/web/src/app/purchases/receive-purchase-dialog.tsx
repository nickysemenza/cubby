/**
 * ReceivePurchaseDialog — put the thing a purchase bought onto a shelf.
 *
...
export const ReceivePurchaseDialog: FC<ReceivePurchaseDialogProps> = ({
  open,
  onOpenChange,
  productId,
  purchaseName,
    ...
    <Dialog open={open} onOpenChange={close}>
      <DialogContent size="md">
        <DialogHeader>
          ...
          <DialogDescription>
            Put what "{purchaseName}" bought onto a shelf.
          </DialogDescription>
        </DialogHeader>
        {body()}
      </DialogContent>
