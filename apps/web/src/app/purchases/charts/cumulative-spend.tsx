import type { PurchaseCumulativePoint } from "@cubby/schemas/project";
 ...
 * `purchase.analytics`'s `cumulative` aggregate (a running sum the server
...
export function CumulativeSpend({
  ...
  cumulative: PurchaseCumulativePoint[];
}) {
