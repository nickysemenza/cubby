...
export function BottomNav() {
  ...
  return (
    <nav
      className="safe-bottom fixed inset-x-0 bottom-0 z-50 border-t-2 border-t-[var(--border-chunky)] bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 md:hidden"
