...
export function PerfOverlay() {
  ...
  if (minimized) {
    return (
      <Row
        ...
        className={cn(
          "fixed z-[60] rounded-md border border-[var(--border)] bg-card px-2 py-1 font-mono text-xs shadow-[var(--shadow-chunky)]",
          CORNER_CLASS[corner],
        )}
      >
  ...
  return (
    <div
      className={cn(
        "fixed z-[60] flex max-h-[70vh] w-80 flex-col overflow-hidden rounded-lg border border-[var(--border)] bg-card font-mono text-xs shadow-[var(--shadow-chunky-lg)]",
        CORNER_CLASS[corner],
      )}
    >
      {/* Header */}
