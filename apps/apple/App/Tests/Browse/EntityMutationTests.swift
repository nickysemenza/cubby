...
@MainActor
@Suite("Entity mutation invalidation")
struct EntityMutationTests {
    @Test func expenseProjectInvalidatesExpenseAndProjectViews() {
        ...
        #expect(model.entityMutationRevision == 1)
        #expect(model.entityMutationKeys == [.expense, .project])
    }
    ...
    @Test func inventoryPlacementInvalidatesInventoryLocationAndProductViews() {
        ...
        #expect(model.entityMutationRevision == 1)
        #expect(model.entityMutationKeys == [.inventory, .location, .product])
