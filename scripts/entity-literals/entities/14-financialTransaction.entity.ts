...
export default literalEntity({
  ...
  model: {
    fields: [
      {
        ...
        description: null,
        readKey: "accountId",
        reference: { entity: "financialAccount", multiple: false },
        control: {
          kind: "specialized",
      ...
      },
      {
        ...
        display: { list: false, detail: true, detailOrder: 70 },
        validation: {
          read: {
            kind: "source",
            source: {
      ...
      },
      {
        ...
        description: null,
        readKey: "ledgerTransferId",
        reference: { entity: "ledgerTransfer", multiple: false },
        control: null,
        display: { list: true, detail: false },
        validation: {
          read: {
      ...
      },
      {
        ...
        description: null,
        readKey: "vendorInference",
        reference: null,
        control: null,
        display: { list: false, detail: true, detailOrder: 20 },
        validation: {
          read: {
            kind: "source",
            source: {
    ...
    storage: [
      ...
      {
        key: "ledgerTransferId",
        column: "ledgerTransferId",
        kind: "identifier",
        nullable: true,
        default: "none",
        defaultValue: null,
        reference: "ledgerTransfer",
        specialized: null,
      },
      {
        key: "kind",
