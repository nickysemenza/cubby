...
/**
 * A workspace package's export subpaths, resolved to file URLs through its
 * own `exports` map. The generator lives outside `apps/web`, so it cannot
 * resolve `@cubby/schemas/<subpath>` as a bare specifier; the file URL of the
